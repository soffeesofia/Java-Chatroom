...
/**
 * Bans a user and updates their information in the UserList.xml file
 */
public class BanUser extends JFrame implements ActionListener {
    ...
    public BanUser(ServerModel serverModel){
        super("User List");
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        for (int i = 0; i < userList.getLength(); i++) {
            ...
            if (u.equals(username)) {
                ...
                isBannedElement.setTextContent("true");
                serverModel.addServerLog("Banned " +  username + " from the Chat" );
                break;
            }
        }
        try {
